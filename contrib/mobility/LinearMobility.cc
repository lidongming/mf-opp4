...
void LinearMobility::makeMove()
{
    ...
    stepTarget.x = move.startPos.x + move.speed * cos(PI * angle / 180) * updateInterval.dbl();
    stepTarget.y = move.startPos.y + move.speed * sin(PI * angle / 180) * updateInterval.dbl();
