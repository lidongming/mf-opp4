 ...
 * @ingroup snrEval
 */
class  GilbertElliotSnr : public SnrEval
{
...
protected:
    ...
    /** @brief Handle state change timer
     *
    ...
    /**
     * @brief Assigns bit errors to all messages.
     *
     * A bad state may be so long that it spans several recvBuffers --
